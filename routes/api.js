...
//Specific Routes
router.use('/courses', require('./generic_router')('course', {
    path: 'study_plans',
    select: ['name']
}))
router.use('/study_plans', require('./generic_router')('study_plan', [{
    path: 'course',
    select: 'name'
}, {
    path: 'exams',
...
router.use('/exams', require('./generic_router')('exam', {
    path: 'teachers',
    select: ['name', 'lastname']
}))
router.use('/exam_sessions', require('./generic_router')('exam_session', {
    path: 'exam_id',
    select: 'name'
}))
...
router.post('/login/:validation_secret', function (req, res) {
    ...
    exec(function (err, student) {
        ...
        Session.findOne({
            'validation_secret': req.params.validation_secret
            ...
            const postData = JSON.stringify({
                ...
                'text': 'Benvenuto ' + student.name + '!\n Per iniziare prova a chiedermi di mostrati il tuo /libretto o digita "/" per accedere alla lista dei comandi princiali.'
            })
